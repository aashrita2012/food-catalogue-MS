...
stage('Docker Build and Push') {
      steps {
          ...
          sh 'docker build -t veerendra1976/food-catalogue-service:${VERSION} .'
          sh 'docker push veerendra1976/food-catalogue-service:${VERSION}'
      }
    }
...
stage('Update Image Tag in GitOps') {
      steps {
        ...
        script {
       sh '''
          sed -i "s/image:.*/image: veerendra1976\\/food-catalogue-service:${VERSION}/" aws/food-catalogue-manifest.yml
        '''
